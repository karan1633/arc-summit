const apiSdkRegistry: any = {
  ...
  'place-order-api': { version: '', method: 'place_order', entity: 'sales_order' },
  'order-list-api': { version: '', method: 'get_orders', entity: 'sales_order' },
  'order-detail-api': { version: '', method: 'get_order_detail', entity: 'sales_order' },
  ...
  'order-reports-api': { version: '', method: 'sales_order_report_list', entity: 'sales_order' },
  ...
  update_sales_order_item_manufacturing_status_details: {
    version: 'v1',
